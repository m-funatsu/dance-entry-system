...
interface FinalsRegulationSectionProps {
  finalsInfo: {
...
export function FinalsRegulationSection({
  finalsInfo,
  onChange,
  isEditable = true
}: FinalsRegulationSectionProps) {
        ...
        <div className="space-y-3">
          <label className="flex items-start">
            <input
              ...
              checked={finalsInfo.lift_regulation || false}
          ...
          <label className="flex items-start">
            <input
              type="checkbox"
              className="mt-1 mr-3 h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 disabled:opacity-50"
              checked={finalsInfo.no_props || false}
          ...
          <label className="flex items-start">
            <input
              type="checkbox"
              className="mt-1 mr-3 h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 disabled:opacity-50"
              checked={finalsInfo.performance_time || false}
          ...
          <label className="flex items-start">
            <input
              type="checkbox"
              className="mt-1 mr-3 h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 disabled:opacity-50"
              checked={finalsInfo.no_antisocial || false}
