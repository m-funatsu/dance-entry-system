...
export const FormField = memo<FormFieldProps>(({
  ...
  const baseInputClass = `w-full px-3 py-2 border rounded-md shadow-sm text-gray-900 font-medium placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 ${
