...
export default function DataExportManager({ totalEntries, totalFiles }: DataExportManagerProps) {
  ...
  const columnNameMap: Record<string, string> = {
    ...
    // 照明シーン情報
    'semifinals_info_scene1_color_type': '照明シーン1 色',
    'semifinals_info_scene1_color_other': '照明シーン1 色・系統その他',
    'semifinals_info_scene1_image': '照明シーン1 イメージ',
    'semifinals_info_scene2_color_type': '照明シーン2 色',
    'semifinals_info_scene2_color_other': '照明シーン2 色・系統その他',
    'semifinals_info_scene2_image': '照明シーン2 イメージ',
    'semifinals_info_scene3_color_type': '照明シーン3 色',
    'semifinals_info_scene3_color_other': '照明シーン3 色・系統その他',
    'semifinals_info_scene3_image': '照明シーン3 イメージ',
    'semifinals_info_scene4_color_type': '照明シーン4 色',
    'semifinals_info_scene4_color_other': '照明シーン4 色・系統その他',
    'semifinals_info_scene4_image': '照明シーン4 イメージ',
    'semifinals_info_scene5_color_type': '照明シーン5 色',
    'semifinals_info_scene5_color_other': '照明シーン5 色・系統その他',
    'semifinals_info_scene5_image': '照明シーン5 イメージ',
    'semifinals_info_chaser_exit_color_type': '照明シーン チェイサー 色',
    'semifinals_info_chaser_exit_color_other': '照明シーン チェイサー 色・系統その他',
    'semifinals_info_chaser_exit_image': '照明シーン チェイサー イメージ',
