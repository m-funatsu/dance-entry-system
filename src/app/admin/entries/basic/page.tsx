      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          <DownloadButton
            ...
            headers={['ID', 'エントリーID', 'ダンスジャンル', 'アマプロ区分', 'エントリー名', 'エントリー名フリガナ', '代表者ローマ字', '代表者メール', '生年月日', 'パートナーエントリー名', 'パートナーエントリー名フリガナ', 'パートナーローマ字', 'パートナー生年月日', '代表者電話番号', '代表者本名', '代表者本名カナ', 'パートナー本名', 'パートナー本名カナ', '緊急連絡先1名前', '緊急連絡先1電話', '緊急連絡先2名前', '緊急連絡先2電話', '保護者名', '保護者電話', '保護者メール', 'パートナー保護者名', 'パートナー保護者電話', 'パートナー保護者メール', '参加資格', 'プライバシーポリシー', '写真・映像使用許諾', '選考ステータス']}
            filename="basic_info"
          />
        </div>
      </div>
