    ...
    const entriesWithUsers = allUsers?.filter(user => user.role === 'participant').map(user => {
      ...
      if (entry) {
        ...
        return {
          ...
          basic_info_status: undefined,
          preliminary_info_status: undefined,
          program_info_status: undefined,
          semifinals_info_status: undefined,
          finals_info_status: undefined,
          sns_info_status: undefined,
          applications_info_status: undefined,
          consent_form_submitted: undefined,
